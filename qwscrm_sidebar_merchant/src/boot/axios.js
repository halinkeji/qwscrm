...
api.interceptors.request.use(
  function (config) {
    ...
    const userLocal = LocalStorage.getItem('qwscrm_merchant_user_info')
    ...
    // config.headers.common.StoreId = 1
    // config.headers.common.LibId = 1
    ...
    switch (response.data.code) {
      case 401:
        Dialog.create({
          ...
          .onOk(() => {
            const agentLocal = LocalStorage.getItem('qwscrm_merchant_agent_info')
