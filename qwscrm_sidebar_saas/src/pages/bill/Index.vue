<template>
  <q-page class="bg-color-EAE full-width column no-wrap">
    <div class="q-mx-xs q-mt-md q-mb-xl">
      <q-card class="shadow-box q-mb-sm">
      ...
      <q-card class="shadow-box q-mb-sm" :key="'log-' + key" v-for="(item, key) in billLogList">
        ...
        <q-card-section class="q-pa-sm">
          <q-list bordered separator>
            <q-item clickable v-ripple v-if="item.contract_id > 0">
              <q-item-section>
                <q-item-label>{{ item.contract ? item.contract.no : '' }}</q-item-label>
                <q-item-label caption lines="1">关联合同编号</q-item-label>
              </q-item-section>
            </q-item>
            <q-item clickable v-ripple v-if="item.contact_follow_id > 0">
              <q-item-section>
            ...
            <q-item clickable v-ripple>
              <q-item-section>
                <q-item-label class="text-red-14 text-subtitle1">开票金额：¥ {{ item.fee }}</q-item-label>
              </q-item-section>
            </q-item>
            <q-item clickable v-ripple>
              <q-item-section>
