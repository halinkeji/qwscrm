...
export const loalHomeUrl = () => {
  LocalStorage.set('qwscrm_saas_home_url', window.location.href)
}

/* 判断localStorage token是否过期 */
export const isLocalStorageTokenExpir = () => {
  const expiredTime = parseInt(
    LocalStorage.getItem('qwscrm_saas_user_info').access_token.expires
  )
  /* 获取本地时间 */
...
export const isAuthenticated = () => {
  return (
    LocalStorage.getItem('qwscrm_saas_user_info') && LocalStorage.getItem('qwscrm_saas_header_local') && LocalStorage.getItem('qwscrm_saas_agent_info')
  )
}
